...
class SoftKeyBoardManager(activity: Activity) {
    ...
    companion object {
         ...
         * @param onSoftKeyBoardChangeListener 监听
         */
        fun setKeyBoardListener(activity: Activity, onSoftKeyBoardChangeListener: OnSoftKeyBoardChangeListener) {
